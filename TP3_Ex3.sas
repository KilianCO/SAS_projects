...
/* 9=2+4+2+2=10
X variables avec les modalités (v3_1, v3_2, v4_1, ... , v8_2) : 10 modalités
H0 : toutes les modalités de X sont indépendantes : P[(x=v1)inter(x=v2)] = P(x=v1)*P(x=v2)
Test d'indép de Chi2 : nD² --> (en loi sous h0) Chi2((10-1)(10-1)) ==> 

z = 668 € R ==> Les modalités de X sont corrélées
On va trouver ces corrélations

Sur l'axe 1 : loyer pas une lourge charge est corrélée avec le fait de ne pas s'imposer des restrictions.
Ces personnes sont à l'opposé de ceux qui s'imposent des restrictions et ont des difficultés avefc le loyer.

Sur l'axe 2 : ceux qui n'ont pas de difficultés avec le loyer s'opposent à ceux qui ont des maux de dos
